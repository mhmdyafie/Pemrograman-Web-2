...
<form method="POST">
  ...
  <div class="form-group row mt-5">
    <div class="offset-4 col-5">
      <button name="submit" type="submit" class="btn btn-primary col-md-3">Kirim</button>
    </div>
  </div>
</form>		</div>
		<div class="col-md-4">
	...
	<hr>
    <?php require_once "fungsi_belanja.php"; ?>
                <tr class="text-center">
                    <th>Nama Customer<td> :  <?= $nama; ?></td></th>
                    <br>
                    <th>Produk Pilihan<td> :  <?= $produk; ?></td></th>
                    <br>
                    <th>Jumlah Beli<td> :  <?= $jumlah; ?></td></th>
                    <br>
                    <th>Total Belanja<td> :  <?= number_format($jumlah_harga);?></td></th>
                 </tr>
			</table>
		</div>
